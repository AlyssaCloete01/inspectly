...
//        logger::debugStart();
        ...
        {
            try {
                $database = 'inspectlydb_qa';
                $hostname = 'unxqa01.kazazoom.com';
                $username = 'inspectly_usr';
                $password = 'extract*direction*precision';
//                logger::debug("Creating the database connection to " . $database . "@" . $hostname);

                $this->_dbConnection = new PDO("mysql:dbname=".$database.";host=".$hostname.";charset=utf8", $username, $password);
